...
export function DropdownMultipleShowcase() {
  ...
  const [modalVal, setModalVal] = useState<string[]>([]);
    ...
    <div className="bg-background min-h-full">
      ...
      <div className="overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div className="">
          ...
          {interVal.length > 0 && (
            <div
              className="mt-4 pl-2 text-[13px] text-muted-foreground"
              style={FONT}
            >
          ...
          <p className="text-muted-foreground mb-8 text-[13px]" style={FONT}>
            DropdownMultiple inside a modal with <code className="text-xs bg-disabled-bg px-1 rounded">overflow: hidden</code> — option list overlays outside the container via portal
          </p>
          <div className="pl-2">
            <button
          ...
          {modalOpen && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40">
              <div
                className="bg-background rounded-2xl shadow-xl w-[400px] flex flex-col gap-4 overflow-hidden"
